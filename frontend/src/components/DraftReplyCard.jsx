    ...
    <div className="card draft-reply-card">
      ...
      <div className="card-body">
        <textarea
          ...
          placeholder={
            hasAnalyzed
              ? "Draft reply generated by agent..."
              : "AI-generated draft reply will appear here after analyzing an inquiry..."
          }
        />
      </div>
      ...
      <div className="card-footer">
        ...
        <div className="dispatch-actions">
          <button
            ...
            disabled={!draftReply}
            onClick={() => alert("Draft saved as internal note.")}
          >
          ...
          <button
            ...
            disabled={!draftReply}
            onClick={() => alert("Response sent to customer.")}
          >
            Send Response
          </button>
        </div>
